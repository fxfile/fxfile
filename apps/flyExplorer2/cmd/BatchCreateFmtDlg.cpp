...
void BatchCreateFmtDlg::DoDataExchange(CDataExchange* pDX)
{
    super::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(BatchCreateFmtDlg, super)
    ON_WM_DESTROY()
    ON_WM_INITMENUPOPUP()
...
xpr_bool_t BatchCreateFmtDlg::OnInitDialog(void) 
{
    super::OnInitDialog();
...
void BatchCreateFmtDlg::OnDestroy(void) 
{
    super::OnDestroy();
...
void BatchCreateFmtDlg::OnTabInit(void)
{
}

void BatchCreateFmtDlg::getFormat(xpr_tchar_t *aFormat, xpr_sint_t aFormatLen)
{
...
void BatchCreateFmtDlg::OnIsNumberEnd(void) 
{
    EnableWindow(XPR_TRUE);
}

void BatchCreateFmtDlg::OnIsNumberCount(void) 
{
    EnableWindow(XPR_FALSE);
}

void BatchCreateFmtDlg::OnFormatMenu(void) 
{
    CRect sRect;
...
xpr_bool_t BatchCreateFmtDlg::OnCommand(WPARAM wParam, LPARAM lParam) 
{
