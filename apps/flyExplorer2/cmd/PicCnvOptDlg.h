...
#ifndef __FX_PIC_CNV_OPT_DLG_H__
#define __FX_PIC_CNV_OPT_DLG_H__
#pragma once
...
class PicCnvOptDlg : public CDialog
{
    typedef CDialog super;

public:
    PicCnvOptDlg(xpr_sint_t aFormat,
...
#endif // __FX_PIC_CNV_OPT_DLG_H__
