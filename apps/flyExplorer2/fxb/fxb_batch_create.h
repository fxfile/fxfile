...
#ifndef __FXB_BATCH_CREATE_H__
#define __FXB_BATCH_CREATE_H__
#pragma once

namespace fxb
{
class BatchCreate : public fxb::Thread
{
public:
    enum CreateType
    {
...
public:
    ...
    Result addPath(const std::tstring &aPath);
