...
#ifndef __FXB_SHELL_COLUMN_H__
#define __FXB_SHELL_COLUMN_H__
#pragma once
...
namespace fxb
{
class ShellColumn : public fxb::Thread, public xpr::Singleton<ShellColumn>
{
    friend class xpr::Singleton<ShellColumn>;
