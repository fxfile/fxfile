...
FormatParser::Result FormatParser::parse(const std::tstring &aFormat,
                                         std::tstring       &aDest,
                                         xpr_uint_t          aNumber,
                                         xpr_size_t          aMaxDestLen)
{
    static const std::tstring sOrgPath;
    static const std::tstring sPath;
    static const std::tstring sFileName;
    static const std::tstring sExt;
...
FormatParser::Result FormatParser::parse(const std::tstring &aOrgPath,
