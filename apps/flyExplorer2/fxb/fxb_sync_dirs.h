...
#ifndef __FXB_SYNC_DIRS_H__
#define __FXB_SYNC_DIRS_H__
#pragma once
...
public:
    ...
    void getSubPath(std::tstring &aSubPath);
    xpr_bool_t getPath(const xpr_tchar_t *aDir, xpr_tchar_t *aPath);
    xpr_bool_t getPath(const xpr_tchar_t *aDir, std::tstring &aPath);
    xpr_bool_t getPath(const std::tstring &aDir, std::tstring &aPath);
...
public:
    ...
    void getDir(std::tstring &aDir1, std::tstring &aDir2);
...
protected:
    void scanRecursiveDir(SyncMap &aSyncMap, const xpr_sint_t aIndex, xpr_uint_t aLevel, const std::tstring &aDir, const std::tstring &aBaseDir);
