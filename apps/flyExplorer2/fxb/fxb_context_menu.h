...
#ifndef __FX_CONTEXT_MENU_H__
#define __FX_CONTEXT_MENU_H__
#pragma once
...
public:
    ...
    static xpr_bool_t trackItemMenu(LPSHELLFOLDER aShellFolder, LPITEMIDLIST *aPidls, xpr_uint_t aCount, LPPOINT aPoint, xpr_uint_t aFlags, HWND aWnd, xpr_uint_t aQueryFlags = CMF_EXPLORE | CMF_CANRENAME);
    static xpr_bool_t trackBackMenu(LPSHELLFOLDER aShellFolder, LPPOINT lppt, xpr_uint_t nFlags, HWND aWnd);
    static xpr_bool_t invokeCommand(LPSHELLFOLDER aShellFolder, LPITEMIDLIST *aPidls, xpr_uint_t aCount, xpr_uint_t aId, HWND aWnd);
    static xpr_bool_t invokeCommand(LPSHELLFOLDER aShellFolder, LPITEMIDLIST *aPidls, xpr_uint_t aCount, const xpr_tchar_t *aVerb, HWND aWnd);
