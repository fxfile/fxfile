...
#ifndef __FX_BOOKMARK_WND_H__
#define __FX_BOOKMARK_WND_H__
#pragma once
...
public:
    ...
    void setBookmark(xpr_sint_t aIndex, fxb::BookmarkItem *aBookmark);
    void getBookmark(xpr_sint_t *aIndex, fxb::BookmarkItem **aBookmark);
...
protected:
    fxb::BookmarkItem *mBookmarkItem;
    xpr_sint_t         mIndex;
