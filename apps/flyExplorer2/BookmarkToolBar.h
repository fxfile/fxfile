...
#ifndef __FX_BOOKMARK_TOOL_BAR_H__
#define __FX_BOOKMARK_TOOL_BAR_H__
#pragma once
...
protected:
    ...
    void addBookmarkButton(xpr_sint_t aIndex, fxb::BookmarkItem *aBookmarkItem);
...
#endif // __FX_BOOKMARK_TOOL_BAR_H__
