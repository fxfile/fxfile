...
BOOL COptionsDialog::OnInitDialog() 
{
    ...
    pCustomizeDialog->AddTextType(m_cbTextType, TBT_TEXT,  theApp.loadString(XPR_STRING_LITERAL("popup.custom_toolbar.text.show")));
    pCustomizeDialog->AddTextType(m_cbTextType, TBT_RIGHT, theApp.loadString(XPR_STRING_LITERAL("popup.custom_toolbar.text.show_on_right")));
    pCustomizeDialog->AddTextType(m_cbTextType, TBT_NONE,  theApp.loadString(XPR_STRING_LITERAL("popup.custom_toolbar.text.none")));
    VERIFY(SelectTextType(m_nTextType));

    pCustomizeDialog->AddIconType(m_cbIconType, TBI_SMALL, theApp.loadString(XPR_STRING_LITERAL("popup.custom_toolbar.icon.small")));
    pCustomizeDialog->AddIconType(m_cbIconType, TBI_LARGE, theApp.loadString(XPR_STRING_LITERAL("popup.custom_toolbar.icon.large")));
    VERIFY(SelectIconType(m_nIconType));

    SetDlgItemText(IDC_CUSTOM_TOOLBAR_LABEL_TEXT_OPTION, theApp.loadString(XPR_STRING_LITERAL("popup.custom_toolbar.label.text_option")));
    SetDlgItemText(IDC_CUSTOM_TOOLBAR_LABEL_ICON_OPTION, theApp.loadString(XPR_STRING_LITERAL("popup.custom_toolbar.label.icon_option")));
