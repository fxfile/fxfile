...
void Option::loadConfigOption(fxfile::base::ConfFileEx &aConfFile)
{
    ...
    if (mConfig.mExplorerCustomIconFile[0][0] == 0)
        _tcscpy(mConfig.mExplorerCustomIconFile[0], XPR_STRING_LITERAL("%fxfile%\\custom_image_list_16.bmp"));

    if (mConfig.mExplorerCustomIconFile[1][0] == 0)
        _tcscpy(mConfig.mExplorerCustomIconFile[1], XPR_STRING_LITERAL("%fxfile%\\custom_image_list_32.bmp"));

    SizeFormat::validSizeUnit(mConfig.mExplorerSizeUnit);
