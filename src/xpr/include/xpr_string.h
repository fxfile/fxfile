...
public:
    ...
    xpr_sint_t compare_incase(const String &aString) const;
    xpr_sint_t compare_incase(const xpr_char_t *aString) const;
    xpr_sint_t compare_incase(xpr_size_t aPos, xpr_size_t aLength, const String &aString) const;
    xpr_sint_t compare_incase(xpr_size_t aPos, xpr_size_t aLength, const xpr_char_t *aString) const;
    xpr_sint_t compare_incase(xpr_size_t aPos1, xpr_size_t aLength1, const String &aString, xpr_size_t aPos2, xpr_size_t aLength2) const;
    xpr_sint_t compare_incase(xpr_size_t aPos1, xpr_size_t aLength1, const xpr_char_t *aString, xpr_size_t aLength2) const;

protected:
    xpr_char_t *alloc(const xpr_size_t &sMinCapacity, xpr_size_t &sCapacity) const;
    void reset(void);
