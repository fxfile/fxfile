...
xcopy "lib\gfl\lib\libgfl340.dll" "bin\x86-multibyte" /c /e /r /y
xcopy "lib\gfl\lib\libgfle340.dll" "bin\x86-multibyte" /c /e /r /y
...
xcopy "lib\mingwrt\bin\libgcc_s_sjlj-1.dll" "bin\x86-multibyte" /c /e /r /y
...
xcopy "lib\mingwrt\bin\libwinpthread-1.dll" "bin\x86-multibyte" /c /e /r /y
...
xcopy "lib\iconv\bin\libiconv-2.dll" "bin\x86-multibyte" /c /e /r /y
xcopy "lib\iconv\bin\libiconv-2.dll" "bin\x86-unicode" /c /e /r /y
xcopy "lib\iconv\bin64\libiconv-2.dll" "bin\x64" /c /e /r /y

xcopy "lib\iconv\bin\libcharset-1.dll" "bin\x86-multibyte" /c /e /r /y
...
xcopy "lib\libxml2\bin\libxml2-2.dll" "bin\x86-multibyte" /c /e /r /y
...
xcopy "lib\libxml2\bin\zlib1.dll" "bin\x86-multibyte" /c /e /r /y
...
xcopy "lib\vld\bin\Win32\vld_x86.dll" "bin\x86-multibyte" /c /e /r /y
xcopy "lib\vld\bin\Win32\dbghelp.dll" "bin\x86-multibyte" /c /e /r /y
xcopy "lib\vld\bin\Win32\Microsoft.DTfW.DHL.manifest" "bin\x86-multibyte" /c /e /r /y
