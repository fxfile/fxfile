...
HICON ShellIcon::getIcon(const std::tstring &aIconPath, xpr_sint_t aIconIndex, const std::tstring &aPath, xpr_bool_t aFastNetIcon, xpr_bool_t aLarge)
{
...
HICON ShellIcon::extractIcon(const std::tstring &aIconPath, xpr_sint_t aIconIndex, xpr_bool_t aLarge)
{
    HICON sIcon = XPR_NULL;
