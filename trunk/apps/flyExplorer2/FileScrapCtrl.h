...
#ifndef __FX_FILE_SCRAP_CTRL_H__
#define __FX_FILE_SCRAP_CTRL_H__
#pragma once
...
public:
    void initList(fxb::FileScrap::Group *aGroup, xpr_bool_t aRedraw = XPR_TRUE);
    void clearList(void);

    void removeItems(const fxb::FileScrap::IdSet &aIdSet);
...
#endif // __FX_FILE_SCRAP_CTRL_H__
