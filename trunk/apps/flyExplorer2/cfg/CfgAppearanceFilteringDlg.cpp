...
xpr_sint_t CfgAppearanceFilteringDlg::insertFilterItem(xpr_sint_t aIndex, fxb::FilterItem *aFilterItem)
{
    LVITEM sLvItem = {0};
...
xpr_sint_t CfgAppearanceFilteringDlg::addFilterItem(fxb::FilterItem *aFilterItem)
{
    xpr_sint_t sIndex;
