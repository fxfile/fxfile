...
void CfgAppearanceFontDlg::OnCustomFontTextBrowse(void) 
{
    ...
    LOGFONT sLogFont = {0};
    fxb::StringToLogFont(sFont, sLogFont);
    ...
    if (sDlg.DoModal() == IDOK)
    {
        ...
        fxb::FontDlgToString(sDlg.GetFaceName(), sDlg.GetSize(), sDlg.GetWeight(), sDlg.IsItalic(), sDlg.IsStrikeOut(), sDlg.IsUnderline(), sText);
