...
void RenTabDlg1::DoDataExchange(CDataExchange* pDX)
{
    super::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(RenTabDlg1, super)
    ON_BN_CLICKED(IDC_BATCH_RENAME_REPLACE_APPLY, OnApply)
    ON_WM_DESTROY()
END_MESSAGE_MAP()

xpr_bool_t RenTabDlg1::OnInitDialog(void) 
{
    super::OnInitDialog();
...
xpr_bool_t RenTabDlg1::PreTranslateMessage(MSG* pMsg) 
{
...
void RenTabDlg1::OnDestroy(void) 
{
    super::OnDestroy();
