...
void WindowSwapFolderCommand::execute(CommandContext &aContext)
{
    ...
    {
        LPITEMIDLIST sFullPidl1 = fxb::CopyItemIDList(sExplorerCtrl1->getFolderData()->mFullPidl);
        LPITEMIDLIST sFullPidl2 = fxb::CopyItemIDList(sExplorerCtrl2->getFolderData()->mFullPidl);
