...
void AttrTimeDlg::setDir(const std::tstring &aDir)
{
    mDir = aDir;
}
...
void AttrTimeDlg::OnOK(void) 
{
    if (mAttrTime != XPR_NULL)
    {
        if (mAttrTime->getStatus() == fxb::AttrTime::StatusChanging)
        {
            mAttrTime->Stop();
            return;
        }
    ...
    switch (sCurSel)
    {
    case 1:  sType = fxb::AttrTime::TypeFolder; break;
    case 2:  sType = fxb::AttrTime::TypeFile | fxb::AttrTime::TypeFolder; break;
    default: sType = fxb::AttrTime::TypeFile; break;
    }
...
LRESULT AttrTimeDlg::OnFinalize(WPARAM wParam, LPARAM lParam)
{
    ...
    switch (sStatus)
    {
    case fxb::AttrTime::StatusChangeCompleted:
        {
    ...
    case fxb::AttrTime::StatusStopped:
        {
