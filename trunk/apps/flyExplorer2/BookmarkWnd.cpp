...
void BookmarkWnd::setBookmark(xpr_sint_t aIndex, fxb::BookmarkItem *aBookmarkItem)
{
    mIndex = aIndex;
...
void BookmarkWnd::getBookmark(xpr_sint_t *aIndex, fxb::BookmarkItem **aBookmarkItem)
{
