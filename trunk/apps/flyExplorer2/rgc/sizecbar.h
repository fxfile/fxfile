...
public:
	...
	void EnableTracking(BOOL bTracking);
	void SetSyncHorz(CRuntimeClass *pBarClass, int cy);
	void SetSyncHorz();
	void SetFloatingSize(CSize sz);
	void SetFloatingSize(int cx, int cy);
...
public:
    ...
    void LoadStateIni(fxb::IniFile *pIniFile, LPCTSTR lpcszEntry = NULL);
    void SaveStateIni(fxb::IniFile *pIniFile, LPCTSTR lpcszEntry = NULL);
    void LoadStateIni(LPCTSTR lpszProfileName);
    void SaveStateIni(LPCTSTR lpszProfileName);
    static void GlobalLoadStateIni(CFrameWnd* pFrame, LPCTSTR lpszProfileName);
    static void GlobalSaveStateIni(CFrameWnd* pFrame, LPCTSTR lpszProfileName);
