...
#ifndef __FX_DRIVE_PIE_CTRL_H__
#define __FX_DRIVE_PIE_CTRL_H__
#pragma once
...
protected:
    std::tstring mTotalSizeText;
    std::tstring mUsedSizeText;
    std::tstring mFreeSizeText;
