 ...
 */
extern "C" void APIENTRY BT_SetLogSizeInEntries(INT_PTR iHandle, DWORD dwLogSizeInEntries)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	if (! EnterLogFunction(pLogFile))
		return;
 ...
 */
extern "C" void APIENTRY BT_SetLogSizeInBytes(INT_PTR iHandle, DWORD dwLogSizeInBytes)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	if (! EnterLogFunction(pLogFile))
		return;
 ...
 */
extern "C" void APIENTRY BT_SetLogFlags(INT_PTR iHandle, DWORD dwLogFlags)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	if (! EnterLogFunction(pLogFile))
		return;
 ...
 */
extern "C" void APIENTRY BT_SetLogLevel(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	if (! EnterLogFunction(pLogFile))
		return;
 ...
 */
extern "C" void APIENTRY BT_SetLogEchoMode(INT_PTR iHandle, DWORD dwLogEchoMode)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	if (! EnterLogFunction(pLogFile))
		return;
 ...
 */
extern "C" void APIENTRY BT_InsLogEntry(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszEntry)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
 ...
 * @param pszEntry - text of message.
 */
extern "C" void APIENTRY BT_AppLogEntry(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszEntry)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
 ...
 */
extern "C" void CDECL BT_AppLogEntryF(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, ...)
{
	va_list argList;
 ...
 */
extern "C" void APIENTRY BT_AppLogEntryV(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, va_list argList)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	WriteLogEntry(pLogFile, eLogLevel, CLogFile::EM_APPEND, pszFormat, argList);
}
 ...
 * @param pszFormat - printf-like message format.
 */
extern "C" void CDECL BT_InsLogEntryF(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, ...)
{
	va_list argList;
	va_start(argList, pszFormat);
	CLogFile* pLogFile = (CLogFile*)iHandle;
 ...
 * @param argList - variable length argument list.
 */
extern "C" void APIENTRY BT_InsLogEntryV(INT_PTR iHandle, BUGTRAP_LOGLEVEL eLogLevel, PCTSTR pszFormat, va_list argList)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	WriteLogEntry(pLogFile, eLogLevel, CLogFile::EM_INSERT, pszFormat, argList);
}
 ...
 * @param iHandle - log file handle.
 */
extern "C" void APIENTRY BT_ClearLog(INT_PTR iHandle)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	if (! EnterLogFunction(pLogFile))
		return;
 ...
 * @param iHandle - log file handle.
 */
extern "C" void APIENTRY BT_CloseLogFile(INT_PTR iHandle)
{
 ...
 * @param iHandle - log file handle.
 */
extern "C" void APIENTRY BT_FlushLogFile(INT_PTR iHandle)
{
	CLogFile* pLogFile = (CLogFile*)iHandle;
	if (! EnterLogFunction(pLogFile))
		return;
