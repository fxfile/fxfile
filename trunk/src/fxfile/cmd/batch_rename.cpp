                                     ...
                                     xpr_bool_t         aByResult)
{
    ...
    xpr::tstring sOrgFile;

    xpr::tstring sOldPath;
    xpr::tstring sOldFile;
    xpr::tstring sNewFile;
    xpr::tstring sExt;
                                      ...
                                      xpr_bool_t         aByResult)
{
    ...
    xpr::tstring sOld = aOld;
    xpr::tstring sNew = aNew;
...
void BatchRename::beginExtProc(xpr_bool_t aNotReplaceExt, xpr::tstring &aPath, xpr::tstring &aExt, xpr_bool_t aFolder)
{
    aExt.clear();
...
void BatchRename::endExtProc(xpr::tstring &aPath, const xpr::tstring &aExt)
{
    aPath += aExt;
}
...
xpr_bool_t BatchRename::renameBatchFormat(const xpr_tchar_t *aFormat)
{
    ...
    std::deque<xpr::tstring> sBackupDeque;
...
xpr_bool_t BatchRename::setBatchFormat(const xpr::tstring &aBatchFormat, xpr_bool_t aHistory)
{
...
xpr_bool_t BatchRename::setBatchFormat(const xpr_tchar_t *aBatchFormat, xpr_bool_t aHistory)
{
    ...
    {
        xpr::tstring sBatchFormat = mBatchFormat;
...
void BatchRename::getBatchFormat(xpr::tstring &aBatchFormat)
{
    aBatchFormat = mBatchFormat;
}

void BatchRename::getBatchFormatFlags(xpr_uint_t aFlags, xpr::tstring &aBatchFormat)
{
    aBatchFormat.clear();
...
xpr_bool_t BatchRename::goBackward(const xpr_tchar_t *aBatchFormat, xpr::tstring &aNewBatchFormat)
{
    if (XPR_IS_NULL(aBatchFormat))
        return XPR_FALSE;
...
xpr_bool_t BatchRename::goForward(const xpr_tchar_t *aBatchFormat, xpr::tstring &aNewBatchFormat)
{
    if (XPR_IS_NULL(aBatchFormat))
        return XPR_FALSE;
